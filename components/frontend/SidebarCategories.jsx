...
export default async function SidebarCategories() {
  ...
  return (
    <div className="sm:col-span-3 md:block bg-white border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-700 text-slate-800 overflow-hidden h-full hidden">
